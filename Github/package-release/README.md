...
1. **Checkout** (`actions/checkout`, pinned to the v7.0.0 SHA, `fetch-depth: 0`) - full history is required by semantic-release.
...
4. **Setup Node.js** (`actions/setup-node`, pinned to the v7.0.0 SHA, Node 22 major line).
