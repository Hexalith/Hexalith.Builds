...
public sealed class RuntimePrerequisiteGateTests
{
    ...
    {
        RuntimePrerequisiteCheck result = RuntimePrerequisiteGate.Check(CreateManifest("1.18.2", "1.18.8"));
    ...
    {
        RuntimePrerequisiteCheck result = RuntimePrerequisiteGate.Check(CreateManifest("1.18.1", "1.18.8"));
