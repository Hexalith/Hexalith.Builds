...
/// <summary>
/// Exports the approved <c>hexalith.module-descriptor.v1</c> entrypoint for the p0-orders fixture module.
/// </summary>
public static class ModuleDescriptorV1
{
    ...
    public static string Describe() =>
        """
        {"schema":"hexalith.module-descriptor.v1","moduleId":"p0-orders","domainServiceProject":"test/fixtures/module/executable/P0Fixture.Orders/P0Fixture.Orders.csproj","uiAssembly":"artifacts/g4-fixture/bin/P0Fixture.Ui/P0Fixture.Ui.dll","uiMarkerType":"Hexalith.Builds.P0Fixture.Ui.OrdersUiMarker"}
        """;
}